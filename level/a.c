...
if (cgt==TILES) n=cursor.curtile-TILE000;
if (cgt==ITEMS) n=cursor.curtile-POWER1;
sprintf(buf, "X = %d  Y = %d  SCREEN = %d  TILE = %d  ", cursor.x,cursor.y,cursor.xscr,n);
textout(screen,font,buf,310,10,255);
